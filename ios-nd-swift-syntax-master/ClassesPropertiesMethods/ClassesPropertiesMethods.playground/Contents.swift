...
var t = tMovie(title: "Point Break", director: "Kathryn Bigelow", releaseYear: 1991)
...
var fridayNightMovie = KidsMovie(title:"Princess Bride", director:"Rob Reiner", releaseYear: 1987, mpaaRating:KidsMovie.permittedRatings[0], reviewScores:[9, 9.5, 10, 9.5])
